...
- Keep dnd_tools map authoritative for “where” only: visualize_map if needed, but combat is journalistic ticks, not 5e HP grind. At scene boundaries snapshots are taken automatically; long_rest between scenes as appropriate via base tools. Map grid = 5ft.=adjacency.
