...
```
=== TRANSCRIPT ===
Initiative: [{'name': 'Pip Quickfingers', 'initiative': 6}, {'name': 'Gunther the Brave', 'initiative': 6}, {'name': 'Goblin1', 'initiative': 3}, {'name': 'Ogre', 'initiative': 2}, {'name': 'Goblin2', 'initiative': 2}, {'name': 'Lyriel Starweave', 'initiative': 1}, {'name': 'Borin Ironfoot', 'initiative': 1}]
...
Pip Quickfingers: I draw my shortsword and lunge at the Ogre, my thief training guiding the strike. The blade finds flesh - 6 damage dealt, the beast now bleeds (4 HP remaining). I step forward to (11, 11) to keep pressure on the wounded giant. <DM/> <DM/>
<End Turn/>
--- Player Turn: Gunther the Brave (round 1) ---
Gunther the Brave: used check_valid_attack_line with {'attacker_name': 'Gunther the Brave', 'defender_name': 'Goblin1'} <DM/>
<End Turn/>
...
=== RESULT ===
{
  ...
  "adventure": {
    "patron": "The Conclave",
    "quest": "Slay the Helvella Dragon",
    "location": "The Wilderlands",
    "threat": "The Great Old One"
  }
}

Tool Calls: 24 
```
*LLM correctly invoked `attack`/`check_character`/`check_valid_attack_line`/`visualize_map` via `SnSTools`, handled S&S number checks (SWORDS < S&S, SORCERY > S&S), WD damage, and divine-intervention ready flow deterministically via seeded dice.*
...
<End Turn/>
--- Player Turn: Pip Quickfingers (round 1) ---
Pip Quickfingers attacks Ogre (SWORDS) [2, 6] vs S&S 3 -> barely damage [1, 6]=>6 Ogre HP 4/10. <DM/>
<End Turn/>
--- Player Turn: Gunther the Brave (round 1) ---
Gunther the Brave attacks Goblin1 (SWORDS) [6, 5] vs S&S 5 -> barely Divine Intervention! damage [1, 5, 4, 1]=>5 Goblin1 HP 0/5. <DM/>
<End Turn/>
--- Monster Turn: Ogre (round 1) ---
Ogre (monster Medium) attacks Pip Quickfingers: Pip Quickfingers SWORDS [1, 1] vs S&S 3 -> success | avoids damage.
<End Turn/>
--- Monster Turn: Goblin2 (round 1) ---
Goblin2 (monster Easy) attacks Lyriel Starweave: Lyriel Starweave SWORDS [2] vs S&S 2 -> barely Divine Intervention! | takes 1 DMG -> 5/6.
<End Turn/>
--- Player Turn: Lyriel Starweave (round 1) ---
Lyriel Starweave casts Icebolt at Ogre sorcery [2, 5] vs S&S 2 -> success damage [5]=>7 Ogre HP 0/10 SP 5/6. <DM/>
<End Turn/>
--- Player Turn: Borin Ironfoot (round 1) ---
Borin Ironfoot attacks Goblin2 (SWORDS) [1, 5] vs S&S 4 -> barely damage [2, 6, 6]=>6 Goblin2 HP 0/5. <DM/>
<End Turn/>
...
Tool Calls: 26
```
*Heuristic fallback uses same tool surface (`heuristic_player_turn`) when LLM unavailable.*

</details>

---

Implements [`ref/sword-and-sorcery.md`](../../ref/sword-and-sorcery.md) faithfully: S&S number 2–5, derived HP=3×S&S, SP=10−2×S&S, WD=S&S−1, EN=S&S+3; 1–3d6 SWORDS (< S&S) / SORCERY (> S&S) with Divine Intervention on exact match; outcomes 0/1/2/3 successes; helping (+1d on next roll); spells known = max SP, level-0 free, level≥1 SORCERY roll + SP cost + damage highest +2×level; only players roll; night's rest restores all HP/SP; monsters Easy/Med/Hard/Deadly HP/DMG; adventure generation via d6 patron/quest/location/threat tables.
...
- **Single scene** (`SnSState` + `SnSTools` + `SnSSimulation`) — one encounter with deterministic 1–3d6 resolution, WD, SP, helping, divine intervention.
